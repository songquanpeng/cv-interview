...
# https://github.com/junleen/RainNet/blob/main/models/normalize.py
...
class RAIN(nn.Module):
    ...
    def forward(self, x, mask):
        ...
        mean_back, std_back = self.get_mean_std(x * (1 - mask), 1 - mask)  # the background features
        ...
        mean_fore, std_fore = self.get_mean_std(x * mask, mask)  # the background features
